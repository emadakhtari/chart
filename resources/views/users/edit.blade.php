...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h4><i class='fa fa-user ml-2'></i> ویرایش کاربر </h4>
                    ...
                    <div class="form-group">
                        @foreach ($ChartCategories as $Categorie)
                            <div class="custom-control custom-checkbox custom-control-inline">
                                {{ Form::checkbox('chartCategories[]',  $Categorie->id ,$ChartCategoriesSelect, ['class' => 'custom-control-input' , 'id' => 'chartCategories_'.$Categorie->id]) }}
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body file-upload" align="center">
                            ...
                            <div id="uploaded_image">
                                @if($user->avatar)
                                    <img class="display-block" src="{{asset('data/users/'.$user->avatar)}}" alt="">
                                    <a href="#" class="btn btn-danger text-white mt-5 deleteAvatar">حذف</a>
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.deleteAvatar').click(function () {
                if (confirm('از حذف تصویر کاربر اطمینان دارید؟')) {
                    $('.avatar').val('');
                    $('#uploaded_image').fadeOut('slow');
                }
                return false;
            });
