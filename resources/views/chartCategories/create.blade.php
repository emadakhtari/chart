...
@section('content')
    <div class="page-header">
        <div>
            <h4><i class='fa fa-bar-chart ml-2'></i> ایجاد دستبندی نمودار </h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد دستبندی نمودار</li>
                </ol>
            </nav>
        </div>
    </div>
    {{ Form::open(array('url' => 'chartCategories')) }}
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-8 mb-8">
                            {{ Form::submit('ایجاد دستبندی نمودار', array('class' => 'btn btn-primary')) }}
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        @if (Route::currentRouteName() == 'chartCategories.create')
        ...
        $(".chartCategoriesCreate").addClass("active");
        @endif
    </script>
@stop
